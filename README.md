...
The checked-in [sample results](docs/distribution.json) describe simulation version 8. All 24,576 sampled spins settled; the largest per-scenario total variation distance was 0.1026, below the 0.2 regression limit. The [duration comparison](docs/duration-comparison.json) compares versions 2 and 3 using identical seed inputs and scenarios, separate from the smaller exploratory sample used to tune the brake.
